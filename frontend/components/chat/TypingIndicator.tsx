  ...
  if (!isMounted) {
    return (
      <div className="flex items-start gap-3 max-w-2xl">
        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-dawn-teal to-dawn-purple flex items-center justify-center shrink-0 mt-0.5 shadow-[0_0_10px_rgba(134,36,255,0.35)]">
          ...
          <div className="flex items-center gap-3">
            <div className="flex gap-1 items-center">
              {[0, 1, 2].map((i) => (
                <div
                  key={i}
                  className="w-1 h-1 rounded-full bg-dawn-teal animate-[typing-dot_1.2s_ease-in-out_infinite]"
            ...
            <div className="flex items-center gap-3 mb-3">
              <div className="flex gap-1 items-center">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className="w-1.5 h-1.5 rounded-full bg-dawn-teal animate-[typing-dot_1.2s_ease-in-out_infinite]"
                    style={{ animationDelay: `${i * 0.2}s` }}
                  />
                ))}
              </div>
