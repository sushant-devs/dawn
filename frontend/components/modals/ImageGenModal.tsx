...
const VARIATIONS = [
  ...
  { 
    ...
    headline: 'Brexiva PFS Efficacy Data',
  ...
  { id: 'var-1', title: 'Variation 1 — Data-Led', gradient: 'linear-gradient(135deg, #0D1B3E 0%, #00A896 100%)', headline: 'Sustained Progression-Free Survival', subline: 'HR+/HER2− mBC — Brexiva Clinical Data', type: 'design' },
  { id: 'var-2', title: 'Variation 2 — Patient-Centric', gradient: 'linear-gradient(135deg, #1a2f5e 0%, #008575 100%)', headline: 'Once-Daily Oral Therapy', subline: 'Simplified treatment. Sustained control.', type: 'design' },
  { id: 'var-3', title: 'Variation 3 — Bold Minimal', gradient: 'linear-gradient(135deg, #0D1B3E 0%, #7C3AED 60%, #00A896 100%)', headline: 'CDK4/6 Inhibitor', subline: 'Brexiva — Proven efficacy data', type: 'design' },
];
...
export default function ImageGenModal({ onConfirm, onClose }: ImageGenModalProps) {
  ...
  const [styleInstructions, setStyleInstructions] = useState(
    'Congress poster for Brexiva clinical data presentation. Deep navy and teal brand palette. Prominently feature PFS efficacy in HR+/HER2− mBC. Include Brexiva logo, Phase II Study citation, and ISI footer zone. Clean clinical aesthetic.'
  );
      ...
      <div className="relative ml-auto w-full max-w-4xl bg-white h-full flex flex-col animate-slide-in-right shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-dawn-border bg-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-serif text-xl text-dawn-navy font-semibold">Image Generator</h2>
              <p className="text-sm text-gray-500 mt-0.5">Generate and customize visual assets</p>
            </div>
          </div>
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        {isiFooter && (
                          <div className="absolute bottom-0 left-0 right-0 bg-black/30 px-2 py-1">
                            <p className="text-white/60 text-[7px] leading-tight">IMPORTANT SAFETY INFORMATION: See full Prescribing Information including Boxed Warning. BREXIVA® (CDK4/6 inhibitor)</p>
                          </div>
                        )}
                      </div>
                    ) : (
