  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-dawn-navy via-dawn-teal to-[#B47CFF] shadow-lg shadow-dawn-navy/25">
          <span className="font-serif text-sm font-bold text-white">D</span>
        </div>
        <div className="flex flex-col">
          <span className="font-heading text-xl font-bold bg-gradient-to-r from-dawn-navy via-dawn-teal to-[#B47CFF] bg-clip-text text-transparent">DAWN</span>
