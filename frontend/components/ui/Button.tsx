...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  const customStyle: CSSProperties = {
    ...
    ...(variant === 'primary'
      ? { background: gradient ?? 'linear-gradient(90deg, #8624FF 0%, #6B1FCC 100%)' }
      : {}),
  };
  ...
  return (
    <button
      ...
      style={customStyle}
      className={[
        'inline-flex items-center justify-center gap-2 font-semibold transition-all duration-200 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 disabled:transform-none',
        sizeClasses[size],
