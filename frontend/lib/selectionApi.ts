...
export async function getSelectionOptions(
  ...
  const baseData = {
    ...
    documents: [
      {
        asset_id: 'doc-001',
        asset_name: 'Clinical Review Report',
        asset_type: 'pdf',
        description: 'Comprehensive clinical review of Brexiva efficacy and safety data',
        file_url: '/data/brexiva/Clinical Review/BREXIVA_Clinical Review Report.pdf',
      },
      {
        asset_id: 'doc-002',
        asset_name: 'Brexiva in Metastatic Breast Cancer',
        asset_type: 'pdf',
        description: 'Clinical review of treatment rationale, patient selection, and evidence considerations',
      ...
      {
        asset_id: 'doc-003',
        asset_name: 'Safety Management Guide',
        asset_type: 'pdf',
        description: 'Practical monitoring considerations for Brexiva-based therapy',
      ...
      {
        asset_id: 'doc-004',
        asset_name: 'Treatment Sequencing Guidelines',
        asset_type: 'pdf',
        description: 'Clinical decision-making for Brexiva-based therapy',
        file_url: '/data/brexiva/Journals/BREXIVA_Treatment Sequencing and Clinical Decision-Making for Brexiva-Based Therapy.pdf',
      },
      {
        asset_id: 'doc-005',
        asset_name: 'Market Insight Report',
        asset_type: 'pdf',
        description: 'Market analysis and competitive landscape for Brexiva',
        file_url: '/data/brexiva/Market Insight Report/BREXIVA_Market Insight Reference Report.pdf',
      },
      {
        asset_id: 'doc-006',
        asset_name: 'MLR Compliance Report',
        asset_type: 'pdf',
        description: 'Medical, legal, and regulatory compliance documentation',
    ...
    approved_assets: [
      {
        ...
        asset_name: 'Abstract Oncology Cellular Visual',
        asset_type: 'image',
      ...
      },
      {
        ...
        asset_name: 'Breast Cancer Pathway Network',
        asset_type: 'image',
      ...
      },
      {
        ...
        asset_name: 'Global Oncology Network',
        asset_type: 'image',
      ...
      },
      {
        ...
        asset_name: 'Patient Advocacy Ribbon Visual',
        asset_type: 'image',
      ...
      },
      {
        ...
        asset_name: 'Precision Oncology DNA Visual',
        asset_type: 'image',
