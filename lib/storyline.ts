      ...
      documentCards: [
        {
          ...
          selected: true,
          filePath: '/data/BREXIVA_LOGO.png',
        },
        {
          id: 'market-insight',
          ...
          selected: true,
          filePath: '/data/Market Insight Report/BREXIVA_Market Insight Reference Report.pdf',
        },
        {
          id: 'mlr-protocols',
          ...
          selected: true,
          filePath: '/data/MLR/BREXIVA_Mlr Compliance Report.pdf',
        },
      ],
    },
    autoAdvance: true,
...
Reviewing BREXIVA_medical-guid.pdf (medical communication standards)...
Checking BREXIVA_Mlr Compliance Report.pdf (compliance protocols)...

Now applying your brand guidelines:
Loading BREXIVA_LOGO.png and usage rules...
...
Opening BREXIVA_Mlr Compliance Report.pdf...
